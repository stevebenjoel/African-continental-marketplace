...
export const ADMIN_ROLE_INFO: Record<AdminRole,{name:string;description:string;href?:string}> = {
  ...
  global_commerce_manager:{name:"Global Commerce Manager",description:"Coordinate approved international supplier operations.",href:"/admin/global-commerce"},
  supplier_integration_manager:{name:"Supplier Integration Manager",description:"Monitor supplier connections, webhooks and synchronization.",href:"/admin/global-commerce"},
  global_catalogue_manager:{name:"Global Catalogue Manager",description:"Review and curate imported Diplomats Stores products.",href:"/admin/global-commerce"},
  global_pricing_manager:{name:"Global Pricing Manager",description:"Manage landed-cost and margin policies.",href:"/admin/global-commerce"},
  global_order_manager:{name:"Global Order Manager",description:"Approve and monitor supplier fulfilment orders.",href:"/admin/global-commerce"},
  global_logistics_manager:{name:"Global Logistics Manager",description:"Manage international shipping and tracking exceptions.",href:"/admin/global-commerce"},
  global_finance_reviewer:{name:"Global Finance Reviewer",description:"Review supplier costs, balances and profitability.",href:"/admin/global-commerce"}
};
