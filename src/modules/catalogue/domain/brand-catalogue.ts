...
export const BRAND_CATALOGUES: readonly BrandCatalogueDefinition[] = [
  ...
  { slug: "lg", name: "LG", aliases: ["LG", "LG Electronics"], headline: "Life-enhancing technology for every room.", description: "Discover LG home appliances, entertainment and electronics supplied and fulfilled by Diplomats Stores on PAC-SM.", accent: "#a50034", available: true },
