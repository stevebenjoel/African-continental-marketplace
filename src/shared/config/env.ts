...
const schema = z.object({
  ...
  APPWRITE_AUTH_API_KEY: z.string().min(1).optional(),
  APPWRITE_AUTH_API_KEY_FILE: z.string().min(1).optional(),
  APPWRITE_STORAGE_API_KEY: z.string().min(1).optional(),
  APPWRITE_STORAGE_API_KEY_FILE: z.string().min(1).optional(),
  APPWRITE_DATABASE_API_KEY: z.string().min(1).optional(),
  APPWRITE_DATABASE_API_KEY_FILE: z.string().min(1).optional(),
