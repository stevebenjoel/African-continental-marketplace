...
const publicRoutes = ["", "/products", "/wholesale", "/pac-sm-products", ...BRAND_CATALOGUES.map(brand => `/brands/${brand.slug}`), "/offtakers", "/procurement", "/trade", "/logistics", "/standards", "/academy", "/faq", "/documentation", "/developers"];
